...
The idea of distinctive collocates is to contrast *two* functionally/semantically similar constructions or words in terms of the collocates that are (significantly) more frequent for one of the two contrasted constructions/words [@hilpert_distinctive_2006; see @gries_extending_2004]. `colloc_leipzig()` can be used to retrieve collocates of *two* functionally/semantically similar words by specifying the `pattern` argument with two character vectors of words. 
...
```{r prepare-dca-input, message = FALSE}
assoc_tb <- assoc_prepare(colloc_out = out,
                          window_span = "r1",
                          per_corpus = FALSE,
                          stopword_list = collogetr::stopwords,
